...
export const PAGE_INFINITE_SCROLL_COPY_COUNT = 31
export const PAGE_INFINITE_SCROLL_SETTLE_MS = 200
export const INFINITE_SCROLL_EDGE_CUSHION_PX = 4

export const HOVER_EDGE_SCROLL_ZONE = 25
export const HOVER_EDGE_SCROLL_PX_PER_SEC = 150
